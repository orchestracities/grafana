...
class DarkColors implements ThemeColorsBase<Partial<ThemeRichColor>> {
  ...
  gradients = {
    brandHorizontal: ' linear-gradient(270deg, #1aafff 0%, #0088d1 100%);',
    brandVertical: 'linear-gradient(0.01deg, #1aafff 0.01%, #0088d1 99.99%);',
  };
...
class LightColors implements ThemeColorsBase<Partial<ThemeRichColor>> {
  ...
  gradients = {
    brandHorizontal: 'linear-gradient(90deg, #1aafff 0%, #0088d1 100%);',
    brandVertical: 'linear-gradient(0.01deg, #1aafff -31.2%, #0088d1 113.07%);',
  };
